...
Doing this by hand is _really_ painful, so **I hacked a custom Vitest reporter to make the test order identification and the bisection job much faster. See [the GitHub Gist](https://gist.github.com/mdubourg001/982493993ce6cbefd061772450dfeb8c)**.
